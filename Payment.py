...
class PaymentWindow(tk.Toplevel):
    def __init__(self, master):
        ...
        tk.Button(self, text="Confirm", command=self.confirm_payment).pack(side=tk.LEFT, padx=10, pady=5)
        tk.Button(self, text="Cancel", command=self.cancel_payment).pack(side=tk.LEFT, padx=10, pady=5)
